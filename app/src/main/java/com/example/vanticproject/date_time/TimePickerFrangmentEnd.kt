...
class TimePickerFrangmentEnd: DialogFragment(), TimePickerDialog.OnTimeSetListener {
    ...
    override fun onTimeSet(view: TimePicker?, hourOfDay: Int, minute: Int) {
        ...
        requireActivity().findViewById<TextView>(R.id.btn_time2).text = "$hourOfDay:$minuteNew:00"
